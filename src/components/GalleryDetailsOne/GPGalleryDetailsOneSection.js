...
class GPGalleryDetailsOneSection extends Component {
	render() {
		return (
						...
						<div className="col-xl-12">
							<div className="gallery-layout-wrapper">
								<div className="gallery-layout-img">
									<img src={require('../../../public/assets/img/gallery/gallery-custom/1.jpg')}
									     alt="image"/>
								</div>
								<div className="gallery-layout-bg"
								     style={{backgroundImage: `url(${'assets/img/gallery/gallery-custom/2.jpg'})`}}>
								...
								<div className="gallery-layout-text">
									<h1>Natural Fresh Strawberry</h1>
...
export default GPGalleryDetailsOneSection;