...
class GPGalleryDetailsFourSection extends Component {
	render() {
		return (
						...
						<div className="col-xl-12">
							<div className="gallery-layout-wrapper">
								<div className="gallery-video-img">
									<img src={require('../../../public/assets/img/gallery/gallery-custom/5.jpg')}
									     alt="image"/>
									<div className="gallerys-video-icon text-center">
										<a className="popup-video" href="https://www.youtube.com/watch?v=yVb0mfmMV9w">
...
export default GPGalleryDetailsFourSection;